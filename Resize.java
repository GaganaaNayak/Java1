...
public class prog7{
    public static void main(String[] args){
        String title0="Lab 7 program-ResizableInterface";
        ...
        String title2="Create a class Rectangle that implements the Resizeable interface and implement the resize methods.";
